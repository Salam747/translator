...
st.title("❤️ AI Translator by Abdul Salam")
# --- UI TEXT IMPROVEMENT ---
...
target_language = st.selectbox("🌍 Select target language:", ["English", "Urdu", "Arabic", "Spanish", "French", "German", "Chinese", "Hindi", "Turkish"])
...
st.markdown("---")
st.markdown("🔗 Made with ❤️ by **Abdul Salam**")
